...
<head>
	...
	<title>JCA Serviços 24 Horas</title>
	...
	<header>
		<div class="container">
			<div class="row">
				<div class="span5">
					<div id="logo">
<!--						<a href="index.html">JCA Assistência 24 Horas</a>-->
		...
		<section class="container">
			<div class="row">
				<div class="span12 countdown">
					<h5 class="countdown-to-launch">EM BREVE NOVO PORTAL.</h5>
					<div class="countDownClock" data-to-date="2021:03:01:00:00:00"></div>
...
<!--		</section>-->
		...
		<div class="row">
			<div class="span5">
				<p>© <?php echo date('Y'); ?> <a href="index.php">JCA Serviços 24 horas</a>.<br>
<!--					<span class="theme-author"><a href="http://themes.tvda.eu" target="_blank">Rudermann Countdown</a> by <a href="http://themes.tvda.eu" target="_blank">TVDA</a>.</span>-->
				</p>
			</div>
			<div class="span7">
				<ul class="social-icons">
					<li><a href="#"><span><i class="icon-facebook"></i></span></a></li>
					<li><a href="#"><span><i class="icon-youtube"></i></span></a></li>
